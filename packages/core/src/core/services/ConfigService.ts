...
import { FieldType, parseConfigList } from "#core/module-system/Module.js";
import { ApplyOptions } from "@sapphire/decorators";
import type { Piece } from "@sapphire/framework";
import type { Prisma } from "@prisma/client";
import { configLock } from "#core/lib/guild-transaction.js";
...
export class ConfigService extends Service {
  public async setConfig(
    ...
    // The Zod schema is the source of truth: validate the coerced value against it.
    // Manifest-driven discovery keeps the schema in code, so resolve it lazily.
    ...
    try {
      ...
      // Notify any module-registered cache invalidation hook for this key
