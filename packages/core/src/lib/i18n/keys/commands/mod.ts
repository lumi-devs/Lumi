...
export const ModerationCommandsKeys = {
  ...
  ModPanicLockedTitle: "commands:modPanicLockedTitle",
  ModPanicLocked: "commands:modPanicLocked",
  ModDuplicateCaseTitle: "commands:modDuplicateCaseTitle",
  ModDuplicateCaseBody: "commands:modDuplicateCaseBody",
  ModDuplicateCaseButton: "commands:modDuplicateCaseButton",
  ...
  KickMembersName: "commands:kickMembersName",
  KickMembersDescription: "commands:kickMembersDescription",
  KickSuccessTitle: "commands:kickSuccessTitle",
  KickSuccess: "commands:kickSuccess",
  KickConfirmTitle: "commands:kickConfirmTitle",
  KickConfirmBody: "commands:kickConfirmBody",
  KickConfirmButton: "commands:kickConfirmButton",
  ...
  NotesName: "commands:notesName",
  NotesDescription: "commands:notesDescription",
  NotesMemberName: "commands:notesMemberName",
  NotesMemberDescription: "commands:notesMemberDescription",
  NotesSuccessTitle: "commands:notesSuccessTitle",
  NotesSuccess: "commands:notesSuccess",
  ...
  BanUsersName: "commands:banUsersName",
  BanUsersDescription: "commands:banUsersDescription",
  ...
  BanConfirmTitle: "commands:banConfirmTitle",
  BanConfirmBody: "commands:banConfirmBody",
  BanConfirmButton: "commands:banConfirmButton",
  ...
  TimeoutConfirmTitle: "commands:timeoutConfirmTitle",
  TimeoutConfirmBody: "commands:timeoutConfirmBody",
  TimeoutConfirmButton: "commands:timeoutConfirmButton",
  ...
  QuarantineConfirmTitle: "commands:quarantineConfirmTitle",
  QuarantineConfirmBody: "commands:quarantineConfirmBody",
  QuarantineConfirmButton: "commands:quarantineConfirmButton",
