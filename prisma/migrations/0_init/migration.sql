...
CREATE TABLE "tracked_threads" (
    ...
    "archive_at" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "tracked_threads_pkey" PRIMARY KEY ("thread_id")
);
...
-- CreateIndex
CREATE INDEX "tracked_threads_guild_id_idx" ON "tracked_threads"("guild_id");

-- CreateIndex
CREATE INDEX "tracked_threads_archive_at_idx" ON "tracked_threads"("archive_at");
