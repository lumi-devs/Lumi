...
- Read the rules in [AGENTS.md](../AGENTS.md) - the "Rules" section at the bottom of this guide summarizes the ones that matter most for day-to-day module work, but AGENTS.md is the source of truth.
